<?php
  ...
  if(!isset($_SESSION['jabatan'])){
    ...
    if(strtolower(str_replace(' ', '', $_SESSION['jabatan'])) != 'administrasi'){
      header("location:".$lvl);
    }
  }
            ...
            <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
              <div class="menu_section">
                ...
                <ul class="nav side-menu">
                  <li class="<?php echo $active[0]?>"><a href="<?php echo $lvl?>pages/administrasi/"><i class="fa fa-home"></i> Dashboard </a></li>
                  <li class="<?php echo $active[1]?>"><a href="<?php echo $lvl?>pages/administrasi/klien"><i class="fa fa-desktop"></i> Klien</a></li>
                </ul>
              </div>
