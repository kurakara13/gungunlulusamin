           ...
           <table id="datatable" class="table table-striped table-bordered">
             ...
             <tbody>
               ...
               <tr>
                 ...
                 <td colspan="3" style="background:orange;color:white;line-height: 37px;"><?php echo $row['keterangan']; ?></td>
               ...
               <?php
                  ...
                  while ($rowDetail = mysqli_fetch_assoc($resultDetail)) {
                    $total = $total + ((float) $rowDetail['volume'] * (float) $rowDetail['harga']);
                ?>
                <tr>
                  <td><?php echo $i++; ?></td>
                  <td><?php echo $rowDetail['detail_pekerjaan']; ?></td>
                  <td><?php echo $rowDetail['volume']; ?></td>
                  <td><?php echo $rowDetail['satuan']; ?></td>
                  <td>Rp. <?php echo number_format($rowDetail['harga']); ?></td>
                  <td>Rp. <?php echo number_format((float) $rowDetail['volume'] * (float) $rowDetail['harga']); ?></td>
                  <td class="text-center">
        ...
        <div class="modal-content">
          ...
          <div class="modal-body">
            ...
            <div class="item form-group">
              ...
              <div class="col-md-8 col-sm-8 col-xs-12">
                <input id="nama_detial_uraian" class="form-control col-md-7 col-xs-12" name="nama_detial_uraian" placeholder="Nama Uraian" required="required" type="text">
              </div>
            </div>
            <div class="item form-group">
