            ...
            <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
              <div class="menu_section">
                ...
                <ul class="nav side-menu">
                  ...
                  <li class="<?php echo $active[5]?>"><a href="<?php echo $lvl?>pages/penanggungjawablapangan/identifikasiresiko"><i class="fa fa-bug"></i>Identifikasi Resiko</a></li>
                  <li class="<?php echo $active[6]?>"><a href="<?php echo $lvl?>pages/penanggungjawablapangan/resiko"><i class="fa fa-bug"></i> Resiko</a></li>
                  <li class="<?php echo $active[7]?>"><a href="<?php echo $lvl?>pages/penanggungjawablapangan/biayaresiko"><i class="fa fa-money"></i> Biaya Resiko</a></li>
                  <li class="<?php echo $active[8]?>"><a href="<?php echo $lvl?>pages/penanggungjawablapangan/evaluasi"><i class="fa fa-bar-chart-o"></i> Evaluasi</a></li>
                  <li class="<?php echo $active[9]?>"><a href="<?php echo $lvl?>pages/penanggungjawablapangan/laporan"><i class="fa fa-book"></i> Laporan</a></li>
                </ul>
              </div>
